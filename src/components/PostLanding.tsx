    ...
    <div>
      {
        postData?.map((item: Post) => (
          <div key={item.id} className='flex flex-col justify-between p-5 rounded-lg my-5'>
            ...
            <div className='flex flex-row justify-between'>
              <div>
                <button className='text-lg font-normal text-slate-800 bg-button p-3 rounded-md mt-5 border-0 hover:shadow-sm hover:shadow-yellow-200'>Do you like this news?</button>
